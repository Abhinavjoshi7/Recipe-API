...
class PrivateRecipeApiTests(TestCase):
    ...
    def partial_update(self):
        """Test partial upadte of a recipe"""
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link='https://exampe.com/recipe.pdf',
            description='Sample test description'
        )
        payload = {
            'title': 'New recipe title',
            'link': 'https://exampe.com/newrecipe.pdf',
            'description': 'New Sample test description',
            'time_minutes': 10,
            'price': Decimal('2.50')
        }
        url = detail_url(recipe.id)
    ...
    def test_delete_recipe(self):
        ...
        self.assertFalse(Recipe.objects.filter(id=recipie.id).exists())
    ...
    def test_update_assingn_ingredient(self):
